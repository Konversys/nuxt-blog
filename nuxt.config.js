module.exports = {
  mode: "universal",
  head: {
    title: "KDV" || process.env.npm_package_name,
    meta: [
      { charset: "utf-8" },
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        hid: "description",
        name: "description",
        content: "Прыжки с парашутом в Барнауле"
      },
      {
        hid: "keywords",
        name: "keywords",
        content:
          "парашут, прыжки, экстрим, прыжки с парашутом, барнаул, алтайский край, прыжки с парашутом в барнауле, подарок, экстримальный отдых"
      }
    ],
    link: [
